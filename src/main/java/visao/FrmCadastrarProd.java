...
import dao.ProdutoCadastrarDao;
...
//função para a carregar as categorias no combobox
    ...
    private void carregarCategoriasNoCombo() {
        ...
        for (Cadastrar categoria : CadastrarDao.getLista()) {
            jComboCategoria.addItem(categoria.getNome());
        }
    }
//função para a tabela ser atualizada
    ...
    public void carregaTabela() {
        ...
        for (CadastrarProduto produtos : ProdutoCadastrarDao.getListaProdutos()) {
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        try {
            ...
            try {
                ...
                ArrayList<CadastrarProduto> produtos = ProdutoCadastrarDao.getListaProdutos();
            ...
            Cadastrar categoriaSelecionada = null;

            for (Cadastrar cat : CadastrarDao.getLista()) {
            ...
            if (ProdutoCadastrarDao.inserirProduto(this.objetoCadastrarProduto)) {
                jTextId.setText("");
                jTextNome.setText("");
                jTextPreco.setText("");
...
// TODO add your handling code here:
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        try {
            ...
            if (ProdutoCadastrarDao.atualizarProduto(produtoAtualizado)) {
                jTextId.setText("");
                jTextNome.setText("");
                jTextPreco.setText("");
                jTextQuantidade.setText("");
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        try {
            ...
            if (respostaUsuario == JOptionPane.YES_OPTION) {
                if (ProdutoCadastrarDao.removerProduto(id)) {
            ...
            System.out.println(ProdutoCadastrarDao.getListaProdutos().toString());
