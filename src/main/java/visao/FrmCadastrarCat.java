...
public class FrmCadastrarCat extends javax.swing.JFrame {
    ...
    private Cadastrar objetoCadastrar;

    public FrmCadastrarCat() {
        initComponents();
        this.objetoCadastrar = new Cadastrar();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cadastrar Cadastrar");
    ...
    private void JButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JButtonCadastrarActionPerformed
        try {
            ...
            try {
                ...
                ArrayList<Cadastrar> categorias = CadastrarDao.getLista();
                for (Cadastrar categoria : categorias) {
            ...
            if (CadastrarDao.inserirCategoria(this.objetoCadastrar)) {
    ...
    private void JButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JButtonEditarActionPerformed
        try {
            ...
            Cadastrar categoriaAtualizada = new Cadastrar(id, nome);

            if (CadastrarDao.atualizarCategoria(categoriaAtualizada)) {
                this.JTextID.setText("");
                this.JTextNome.setText("");
                JOptionPane.showMessageDialog(rootPane, "Categoria Alterada com Sucesso!");
            }

            System.out.println(CadastrarDao.getLista().toString());
    ...
    private void JButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JButtonExcluirActionPerformed
        try {
            ...
            if (respostaUsuario == JOptionPane.YES_OPTION) {
                if (CadastrarDao.removerCategoria(id)) {
